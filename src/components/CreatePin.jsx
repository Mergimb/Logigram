          ...
          <div className='flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420'>
            ...
            {!imageAsset ? (
              <label>
                ...
                <div className='flex flex-col justify-center items-center'>
                  ...
                  <p className='mt-32 text-gray-400'>
                   Use hight-quality JPG, SVG, PNG, GIF less than 20 MB
                  </p>
                </div>
                <input 
                  type='file'
              ...
              <div className='relative h-full'>
                ...
                <button
                type='button'
                className='absolute bottom-3 right-3 p-3 rounded-full bg-white text-xl custor-pointer outline-none hover:shadow-md transition-all duration-500 ease-in-out'
